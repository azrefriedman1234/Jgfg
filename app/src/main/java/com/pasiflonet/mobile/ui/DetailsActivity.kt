...
setContentView(R.layout.activity_details)
    ...
    private fun enqueueSendAndClose() {
        ...
        val req = OneTimeWorkRequestBuilder<SendWorker>().addTag("SEND_WORK").addTag(com.pasiflonet.mobile.worker.SendWorker.TAG_SEND).addTag("SEND_WORK").addTag("SEND_WORK").addTag("SEND_WORK").addTag("SEND_WORK").addTag("SEND_WORK")
            .setInputData(data)
            .build()
